...
def cmd_print_row(img_row):
    ...
    #img_row[2] = 1
    #img_row[3] = 1
    #img_row[len(img_row) - 1] = 1
    #img_row[len(img_row) - 2] = 1
    #img_row[len(img_row) - 3] = 1
    #img_row[len(img_row) - 4] = 1
...
def cmds_print_img(img, dark_mode=False, no_feed=False):

    #print("DARK_MODE: " + str(dark_mode))
    #PRINTER_MODE = CMD_PRINT_TEXT if dark_mode else CMD_PRINT_IMG
    feed_count = 0 if no_feed else 25
